...
**This release is build 29.** The footer at the bottom of every screen shows the build
number, which is how you confirm a phone has it. Build 29 includes everything from
...
4. Commit message: `Build 29: bodyweight on split squats, lunges and the rest`.
...
3. Check: the footer at the bottom of the screen says **Gauntlet, build 29**.
...
3. Open it again. Scroll to the bottom of any screen: the footer should say **build 29**,
...
git commit -m "Build 29: bodyweight on split squats, lunges and the rest"
git push
```
