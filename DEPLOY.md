...
**This release is build 21.** The footer at the bottom of every screen shows the build
number, which is how you confirm a phone has it. Build 21 includes everything from
build 20, so if you skipped build 20, this one release brings you fully up to date.
...
4. Commit message: `Build 21: You screen, sessions open, habits to stop, theme fix, updates reach phones`.
...
3. Check: the footer at the bottom of the screen says **Gauntlet, build 21**.
...
3. Open it again. Scroll to the bottom of any screen: the footer should say **build 21**,
...
git commit -m "Build 21: You screen, sessions open, habits to stop, theme fix, updates reach phones"
git push
```
