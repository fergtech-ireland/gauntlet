...
**This release is build 27.** The footer at the bottom of every screen shows the build
number, which is how you confirm a phone has it. Build 27 includes everything from
...
4. Commit message: `Build 27: home screen rebuilt`.
...
3. Check: the footer at the bottom of the screen says **Gauntlet, build 27**.
...
3. Open it again. Scroll to the bottom of any screen: the footer should say **build 27**,
...
git commit -m "Build 27: home screen rebuilt"
git push
```
