...
**This release is build 22.** The footer at the bottom of every screen shows the build
number, which is how you confirm a phone has it. Build 22 includes everything from
...
4. Commit message: `Build 22: easier editing, full session detail, circuit editor, today's workout easier to find`.
...
3. Check: the footer at the bottom of the screen says **Gauntlet, build 22**.
...
3. Open it again. Scroll to the bottom of any screen: the footer should say **build 22**,
...
git commit -m "Build 22: easier editing, full session detail, circuit editor, today's workout easier to find"
git push
```
