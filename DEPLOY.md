...
**This release is build 34.** The footer at the bottom of every screen shows the build
number, which is how you confirm a phone has it. Build 34 includes everything from
...
4. Commit message: `Build 34: calories over target show the overage and maintenance`.
...
3. Check: the footer at the bottom of the screen says **Gauntlet, build 34**.
...
3. Open it again. Scroll to the bottom of any screen: the footer should say **build 34**,
...
git commit -m "Build 34: calories over target show the overage and maintenance"
git push
```
