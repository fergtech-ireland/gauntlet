...
**This release is build 23.** The footer at the bottom of every screen shows the build
number, which is how you confirm a phone has it. Build 23 includes everything from
...
4. Commit message: `Build 23: tiles to log with, You in tabs, working weight chart`.
...
3. Check: the footer at the bottom of the screen says **Gauntlet, build 23**.
...
3. Open it again. Scroll to the bottom of any screen: the footer should say **build 23**,
...
git commit -m "Build 23: tiles to log with, You in tabs, working weight chart"
git push
```
