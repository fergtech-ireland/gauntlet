...
**This release is build 45.** The footer at the bottom of every screen shows the build
number, which is how you confirm a phone has it. Build 45 includes everything from
...
4. Commit message: `Build 45: coming back after a break, pain, readiness`.
...
3. Check: the footer at the bottom of the screen says **Gauntlet, build 45**.
...
3. Open it again. Scroll to the bottom of any screen: the footer should say **build 45**,
...
git commit -m "Build 45: coming back after a break, pain, readiness"
git push
```
