...
**This release is build 24.** The footer at the bottom of every screen shows the build
number, which is how you confirm a phone has it. Build 24 includes everything from
...
4. Commit message: `Build 24: bigger food list, rebuilt exercise drawings`.
...
3. Check: the footer at the bottom of the screen says **Gauntlet, build 24**.
...
3. Open it again. Scroll to the bottom of any screen: the footer should say **build 24**,
...
git commit -m "Build 24: bigger food list, rebuilt exercise drawings"
git push
```
